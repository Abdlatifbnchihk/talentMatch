...
AI structured output layer for candidate analysis. Provides typed DTOs, JSON schemas for laravel/ai, and service integration to call Claude Sonnet for structured analysis of candidate CVs against job offers.
